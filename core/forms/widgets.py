...
from django.forms import TextInput, CheckboxInput, ClearableFileInput, RadioSelect, Select, MultiWidget, DateInput
...
class StarRatingSelect(Select):
    ...
    class Media:
        css = {
            "all": ["core/star-rating-js/4.3.1/star-rating.min.css"],
        }
        js = [
            "core/star-rating-js/4.3.1/star-rating.min.js",
        ]
