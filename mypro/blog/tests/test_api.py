...
@pytest.mark.describe("포스팅 업데이트 API 테스트")
class TestPostUpdateGroup:
    @pytest.mark.it("작성자가 아닌 유저가 수정 요청하면 거부")
    @pytest.mark.django_db
    def test_non_author_cannot_update_post(self, new_post, api_client_with_new_user_basic_auth):
    ...
    @pytest.mark.django_db
    def test_author_can_update_post(self, faker):
